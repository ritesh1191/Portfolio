...
ScrollReveal().reveal(".home-content h1,.testimonial-wrapper", {
  origin: "left",
});

ScrollReveal().reveal(".home-content p,.about-content, .container ul li", {
  origin: "right",
});
...
// Change copyright date automatically
